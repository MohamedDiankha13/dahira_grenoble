    ...
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-6">
          ...
          Au fil du temps, le nombre de participants augmenta, et le dahira prit forme officiellement en <strong>2017</strong> sous le nom de <strong>"Dahira Moutahlikhina Touba Grenoble"</strong>, en l'honneur de Serigne Touba.<br /><br />
